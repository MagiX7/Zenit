...
IncludeDir["spdlog"] = "%{wks.location}/Zenit/Dependencies/spdlog/include"
IncludeDir["assimp"] = "%{wks.location}/Zenit/Dependencies/Assimp/include"
IncludeDir["node_editor"] = "%{wks.location}/Zenit/Dependencies/imgui-node-editor"
IncludeDir["parson"] = "%{wks.location}/Zenit/Dependencies/parson"
